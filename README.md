...
A comprehensive Capacitor 7 plugin for video and audio recording on iOS, Android, and Web platforms. This plugin provides all the essential features of @ionic-enterprise/media-capture without the enterprise licensing requirements.

> ✨ **Fully compatible with Capacitor 7.0+** - Updated for the latest Capacitor version with enhanced performance and modern APIs.
...
```bash
npm install @zhengxiaolang/capacitor-video-recorder
npx cap sync
```
